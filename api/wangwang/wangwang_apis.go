...
func (r *WangwangEserviceAccountstatusGetRequest) SetBtime(value string) {
...
1. 查询时间必须在30天之内。
2. 起始时间和结束时间间隔不超过7天。<br /> 支持最大长度为：19<br /> 支持的最大列表长度为：19 */
func (r *WangwangEserviceAccountstatusGetRequest) SetEtime(value string) {
...
func (r *WangwangEserviceAccountstatusGetRequest) SetUid(value string) {
	r.SetValue("uid", value)
}

func (r *WangwangEserviceAccountstatusGetRequest) GetResponse(accessToken string) (*WangwangEserviceAccountstatusGetResponse, []byte, error) {
	var resp WangwangEserviceAccountstatusGetResponseResult
	data, err := r.TaobaoMethodRequest.GetResponse(accessToken, "taobao.wangwang.eservice.accountstatus.get", &resp)
	if err != nil {
		return nil, data, err
	}
	return resp.Response, data, err
...
type WangwangEserviceAccountstatusGetResponseResult struct {
	Response *WangwangEserviceAccountstatusGetResponse `json:"wangwang_eservice_accountstatus_get_response"`
}
...
type WangwangEserviceNewloginlogsGetResponse struct {
	Userloginlogs struct {
		UserLoginlog []*UserLoginlog `json:"user_loginlog"`
	} `json:"userloginlogs"`
}
